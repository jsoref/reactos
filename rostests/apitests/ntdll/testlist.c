...
extern void func_RtlGetLengthWithoutTrailingPathSeparators(void);
...
const struct test winetest_testlist[] =
{
    ...
    { "RtlGetLengthWithoutTrailingPathSeparators", func_RtlGetLengthWithoutTrailingPathSeparators },
